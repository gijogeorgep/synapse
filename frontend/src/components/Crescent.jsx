...
const Crescent = () => {
    return (
        <section className="w-full bg-slate-50 py-16 px-6 md:px-20 font-['Plus_Jakarta_Sans',sans-serif]">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    {[cresent12, cresent10, cresent9].map((img, i) => (
                        <div key={i} className="group overflow-hidden rounded-[2rem] shadow-sm transition-all duration-300 hover:shadow-xl">
                            <img 
                                src={img} 
                                alt={`Campus view ${i+1}`} 
                ...
                <div className="bg-white rounded-[3rem] border border-slate-200/60 p-8 md:p-12 shadow-[0_15px_40px_-15px_rgba(0,0,0,0.03)] flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div className="md:w-1/2 h-[280px] w-full rounded-[2rem] overflow-hidden border border-slate-100 shadow-inner ring-1 ring-slate-100">
                        <iframe
