...
const Testimonials = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.16),transparent_30%),linear-gradient(180deg,#f8fafc_0%,#ecfeff_42%,#f8fafc_100%)] px-6 py-24 md:px-10"
    >
            ...
            <div className="relative overflow-hidden rounded-[2.25rem] border border-white/50 bg-white/42 p-7 shadow-[0_22px_70px_rgba(15,23,42,0.09)] backdrop-blur-2xl md:p-10">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-5 text-base leading-8 text-slate-600 md:text-lg">
                  This area works best before FAQ and contact because it gives
                  visitors confidence right before they decide to ask questions
                  or reach out.
                </p>
