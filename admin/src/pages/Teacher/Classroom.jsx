                            ...
                            <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-5xl h-[85vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
                                ...
                                <div className="flex-1 bg-slate-50 relative overflow-hidden">
                                    {(() => {
                                        ...
                                        // Lecture notes: always try PDF preview first (backend/proxy decides actual content-type).
                                        // This avoids UI-side type detection failures for older notes with missing extensions.
